...
export const columns: () => Array<TableColumn<IAccount>> = () => [
    {
        key: 'user',
            ...
            <td className='whitespace-nowrap py-3 pl-2 pr-3 text-xs sm:pl-3 sm:text-sm'>
                <div className='flex items-center gap-2 px-4 py-2'>
                    ...
                    <div className='flex-1'>
                        ...
                        <small className='block truncate font-normal text-gray-500 dark:text-slate-400'>{email}</small>
                    </div>
                </div>
            </td>
        ),
                ...
                <button
                    ...
                    className={clsx(
                        `
                            ...
                            p-2 
                        `,
                        allowSendMail ? 'bg-cyan-400 text-gray-100' : 'bg-slate-100 text-gray-400 dark:bg-slate-700'
                    )}
                >
