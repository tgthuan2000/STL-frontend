...
const Achievement = React.lazy(() => import('../components/Tab/Achievement'))
const Rights = React.lazy(() => import('../components/Tab/Rights'))
const Statistics = React.lazy(() => import('../components/Tab/Statistics'))
